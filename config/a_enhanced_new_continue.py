...
config.name = "a_enhanced_new"
config.batch_size = 64
config.epoch = 100
config.lr = 2e-4
config.wd = 5e-5
config.hidden_size = 512
config.model_name = "a_enhanced_new"
...
config.MODEL_FOLDER_NAME = 'a_enhanced_new'
...
config.continue_model_path = os.path.join(config.MODEL_DIR, config.MODEL_FOLDER_NAME,
                                          "a_enhanced_new__EP-100__04-05_13-51-47__7.417721518987341__.model")
