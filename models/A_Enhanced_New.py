...
__all__ = ['A_Enhanced_New']


class A_Enhanced_New(torch.nn.Module):
    def __init__(self, hidden_size):
        super(A_Enhanced_New, self).__init__()
        ...
        self.encoder = torch.nn.GRU(hidden_size >> 1, hidden_size, bidirectional=True, num_layers=5, dropout=0.2)
